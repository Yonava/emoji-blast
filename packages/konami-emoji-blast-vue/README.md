...
<p align="center">
	...
	<a href="http://npmjs.com/package/@konami-emoji-blast/vue"><img alt="📦 npm version" src="https://img.shields.io/npm/v/@konami-emoji-blast/vue?color=21bb42&label=%F0%9F%93%A6%20npm" /></a>
...
👉 See docs on **[emojiblast.dev](https://emojiblast.dev)** > [Integrations > Vue](https://www.emojiblast.dev/integrations/vue).

## Development

`@konami-emoji-blast/vue` is managed as part of the <a href="https://github.com/JoshuaKGoldberg/emoji-blast">emoji-blast monorepo</a>.
